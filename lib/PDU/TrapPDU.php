...
class TrapPDU implements PDU
{
    ...
    /**
     * @param TrapPDUBody $body
     */
    public function __construct(TrapPDUBody $body)
    {
        $this->body = $body;
    }

    public function getBody(): TrapPDUBody
    {
        return $this->body;
    }
    ...
    public static function fromASN1(TaggedType $obj): self
    {
        ...
        try {
            ...
            throw new DecodeError('Trap PDU must be a sequence', 0, $e);
        }
        $body = TrapPDUBody::fromASN1($children);
