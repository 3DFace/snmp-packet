...
class GetBulkRequestPDU implements PDU
{
    ...
    /**
     * @param BulkPDUBody $body
     */
    public function __construct(BulkPDUBody $body)
    {
        $this->body = $body;
    }

    public function getBody(): BulkPDUBody
    {
        return $this->body;
    }
    ...
    public static function fromASN1(TaggedType $obj): self
    {
        ...
        try {
            ...
            throw new DecodeError('GetBulkRequest PDU must be a sequence', 0, $e);
        }
        $body = BulkPDUBody::fromASN1($children);
