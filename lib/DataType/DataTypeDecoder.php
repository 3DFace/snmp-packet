        ...
        try {
            switch ($class) {
                ...
                default:
                    ...
                    throw new DecodeError("SNMP does not support ASN1 type '$class_name'");
            }
        } catch (\UnexpectedValueException $e) {
            $class_name = Identifier::classToName($class);
            $tag_name = Element::tagToName($tag);
            throw new DecodeError("Cant decode value from class '$class_name', tag '$tag_name': "
                . $e->getMessage(), 0, $e);
        }
