...
use dface\SnmpPacket\PDU\TrapV2PDU;
use dface\SnmpPacket\VarBind\VarBind;
use dface\SnmpPacket\VarBind\VarBindList;
use PHPUnit\Framework\TestCase;

class TrapV2PDUTest extends TestCase
{

    private const example = 'a71e02010102010002010030133011060d2b0601040194780102070302000500';
