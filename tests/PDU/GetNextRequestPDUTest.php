...
use dface\SnmpPacket\PDU\GetNextRequestPDU;
use dface\SnmpPacket\PDU\PDUDecoder;
use dface\SnmpPacket\VarBind\VarBind;
use dface\SnmpPacket\VarBind\VarBindList;
use PHPUnit\Framework\TestCase;

class GetNextRequestPDUTest extends TestCase
{

    private const example = 'a11e02010102010002010030133011060d2b0601040194780102070302000500';
    ...
    public function testEncoded()
    {
        ...
        $pdu = new GetNextRequestPDU($pdu_body);
        $bin = $pdu->toBinary();
