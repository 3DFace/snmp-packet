...
use dface\SnmpPacket\PDU\SetRequestPDU;
use dface\SnmpPacket\VarBind\VarBind;
use dface\SnmpPacket\VarBind\VarBindList;
use PHPUnit\Framework\TestCase;

class SetRequestPDUTest extends TestCase
{

    private const example = 'a31e02010102010002010030133011060d2b0601040194780102070302000500';
    ...
    public function testEncoded()
    {
        ...
        $pdu = new SetRequestPDU($pdu_body);
        $bin = $pdu->toBinary();
